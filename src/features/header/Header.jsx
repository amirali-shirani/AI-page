...
const Header = () => {
    ...
    return (
        <div dir="rtl" className="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center
         bg-white/80 w-full dark:bg-dark-bg/80 backdrop-blur-sm sticky top-0 z-10 h-16 ">
            ...
            <div className="flex items-center gap-3">
                ...
                <h1 className={`text-lg md:text-xl font-bold bg-clip-text dark:text-gray-200 
